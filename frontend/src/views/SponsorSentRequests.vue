    ...
    <div>
        <div class="sent-adrequests">
            <div>
                ...
                <p>Here you can see the status of the ad requests you have sent to influencers.</p>
            </div>
        </div>
...
export default {
    ...
    methods: {
        async getSentAdRequests() {
            try {
                const response = await axios.get('/sponsor/sent_adrequests');
        ...
        goToUpdateAdrequest(adrequest_id) {
            this.$router.push({ name: 'SponsorUpdateAdrequest', params: { id: adrequest_id } });
        }
    }
}
</script>
